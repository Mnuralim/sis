...
interface Props {
  modal: "add" | "edit";
  selectedActivty?: Activity | null;
  onClose: () => void;
}

export const ActivityForm = ({ modal, selectedActivty, onClose }: Props) => {
  const [state, action, pending] = useActionState(
    selectedActivty ? updateActivity : createActivity,
    {
      error: null,
    }
  );
    ...
    <div className="w-full max-w-2xl mx-auto">
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">
          {modal === "add" ? "Tambah Kegiatan" : "Edit Kegiatan"}
        </h2>
        <p className="text-sm text-gray-600">
          {modal === "add"
            ? "Lengkapi informasi untuk menambahkan kegiatan baru"
      ...
      <Form action={action} className="space-y-6">
        <input
          type="hidden"
          name="id"
          defaultValue={selectedActivty?.id || ""}
        />
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input
                ...
                id="name"
                name="name"
                defaultValue={selectedActivty?.name || ""}
            ...
            <div>
              ...
              <textarea
                ...
                name="description"
                rows={3}
                defaultValue={selectedActivty?.description || ""}
                placeholder="Deskripsi singkat tentang kegiatan (opsional)"
