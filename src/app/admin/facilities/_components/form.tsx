...
export const FacilityForm = ({ modal, selectedFacility, onClose }: Props) => {
  const [state, action, pending] = useActionState(
    selectedFacility ? updateFacility : createFacility,
    {
      error: null,
    }
  );
    ...
    <div className="w-full max-w-2xl mx-auto">
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">
          {modal === "add" ? "Tambah Fasilitas" : "Edit Fasilitas"}
        </h2>
        <p className="text-sm text-gray-600">
          {modal === "add"
            ? "Lengkapi informasi untuk menambahkan fasilitas baru"
            : "Perbarui informasi fasilitas sesuai kebutuhan"}
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Deskripsi singkat tentang fasilitas (opsional)"
